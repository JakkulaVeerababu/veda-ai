        ...
        <main className="flex-1 overflow-y-auto bg-white rounded-tl-2xl relative p-6">
          <div className="max-w-6xl mx-auto px-6 py-8">
            <div className="flex justify-between items-end mb-8">
              <div>
                <h1 className="text-3xl font-bold text-veda-dark tracking-tight">Welcome back, Veerababu</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 bg-white rounded-2xl border border-veda-gray-200 shadow-sm p-6">
                ...
                {data.recentActivity.length === 0 ? (
                  <div className="py-10 flex flex-col items-center justify-center text-center border-2 border-dashed border-veda-gray-100 rounded-xl bg-veda-gray-50/30">
                    <ClipboardList className="text-veda-gray-300 mb-3" size={28} />
                    <p className="text-veda-gray-500 font-medium">No recent activity</p>
                    <p className="text-sm text-veda-gray-400 mt-1">Your recent actions will appear here.</p>
                  </div>
                ) : (
              ...
              <div className="bg-white rounded-2xl border border-veda-gray-200 shadow-sm p-6">
                ...
                {data.upcomingTasks.length === 0 ? (
                  <div className="py-10 flex flex-col items-center justify-center text-center border-2 border-dashed border-veda-gray-100 rounded-xl bg-veda-gray-50/30">
                    <CheckCircle className="text-veda-gray-300 mb-3" size={28} />
                    <p className="text-veda-gray-500 font-medium">All caught up!</p>
                    <p className="text-sm text-veda-gray-400 mt-1">No pending tasks on your schedule.</p>
                  </div>
                ) : (
                  <>
